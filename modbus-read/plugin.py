...
#
"""
<plugin key="Modbus" name="Modbus RTU/ASCII/TCP - READ" author="S. Ebeltjes / domoticx.nl" version="2.0.0" externallink="" wikilink="https://github.com/DomoticX/domoticz-modbus/">
    <params>
